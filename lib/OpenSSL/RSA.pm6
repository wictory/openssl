...
our sub RSA_public_encrypt(int32, Blob, Blob, OpaquePointer, int32 --> int32) is native(&gen-lib) { ... }
our sub RSA_private_decrypt(int32, Blob, Blob, OpaquePointer, int32 --> int32) is native(&gen-lib) { ... }
